...
namespace SAO.Client
{
    ...
    public sealed class Universe
    {
        ...
        /// <summary>
        /// windows manager of the SAO world.
        /// </summary>
        ...
        private void __checkFiles__()
        {
            ...
            if (IsWindows)
            {
                // it means that the current platform is windows....
                // its somehow weird, but can't help it, return the method.
                return;
            }
