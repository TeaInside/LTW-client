...
namespace SAO.GameObjects.Kingdoms
{
    public class PowerRankings : Rankings
    {
        ...
        /// </summary>
        public const string PowerRankings_LOC = "ぱウェーランキング.Sao";
        /// <summary>
        ...
        private const string MESSAGE = "P_R -- SAO";
        ...
        public static async Task<bool> DeletePowerRankings(SAO_Kingdoms _kingdom_)
        {
